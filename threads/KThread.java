...
public class KThread {
	...
	public static void finish() {
		...
		//if the sleep queue exists we need to put them back in the ready queue
		if (sleepQueue != null){
			readyQueue = sleepQueue;
		}
		sleep();
	}
	...
	public void join() {
		...
		//if there is no waiting queue create one and add thread to it
		if (sleepQueue == null) { 
			sleepQueue = ThreadedKernel.scheduler.newThreadQueue(true);
			sleepQueue.acquire(this);
		}
	...
	private static ThreadQueue sleepQueue = null; //a sleep queue for processes waiting to join
